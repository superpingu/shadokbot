	...
	mYellowLed(YELLOW_LED, sf::Color::Yellow, MM_TO_PX(500), MM_TO_PX(150))
{
	...
	mSensorList[0] = new DistanceSensor({0,0,0});
	mSensorList[1] = new DistanceSensor({0,0,-60});
	mSensorList[2] = new DistanceSensor({0,0,-120});
	mSensorList[3] = new DistanceSensor({0,0,-180});
	mSensorList[4] = new DistanceSensor({0,0,60});
	mSensorList[5] = new DistanceSensor({0,0,120});
