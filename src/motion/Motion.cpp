...
int16_t Motion::maxAcceleration(int16_t acc = 0) {
...
uint16_t Motion::minSpeed(int16_t speed = 0) {
...
void Motion::moveFinished(void (*func)()) {
	move_finished = func;
}
...
void Motion::turn(int16_t angle, uint16_t angular_speed) {
...
void Motion::move(uint16_t distance, int16_t angle, uint16_t speed) {
