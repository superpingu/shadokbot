...
#define DEFAULT_MAX_ACCELERATION (200*MM_PER_S2_TO_HALFTICK_PER_SPEEDTU2)
#define DEFAULT_MIN_SPEED (30*MM_PER_S_TO_HALFTICK_PER_SPEEDTU)
#define DEFAULT_RECAL_SPEED (200*MM_PER_S_TO_HALFTICK_PER_SPEEDTU)
#define DEFAULT_RECAL_DISTANCE (50*MM_TO_HALFTICK)

#define RECAL_COLLISION_THRESHOLD 1000000
